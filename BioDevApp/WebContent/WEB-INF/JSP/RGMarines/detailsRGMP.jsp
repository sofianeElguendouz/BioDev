...
<body>
	...
	<div class="container" style="color:#4D4F5C;">
		<div>
			...
			<img align="right" src="${sessionScope.rgp.getImage()}" class="img-thumbnail">
			<h2 style="text-align:left">${sessionScope.rgp.getNom_francais()}</h2>
			<h5 style="text-align:left;">${sessionScope.rgp.getNom_latin()} | (Cocco, 1833) <br>N°168</h5>
			...
			<table class="table">
			  ...
			  <tbody>
			    ...
			    <tr>
			      ...
			      <td>
			      		<img src="${sessionScope.rmp.getImage1()}" class="img-thumbnail">
